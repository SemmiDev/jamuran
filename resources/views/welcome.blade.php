...
<head>
    ...
    <title>Jamur Nagari Limau Manis</title>
    <meta content="Jamur Nagari Limau Manis" name="description">
    <meta content="Jamur Nagari Limau Manis" name="keywords">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                ...
                <h1 class="sitename">Jamur Nagari Limau Manis</h1>
            </a>
        ...
        <section id="hero" class="hero section">
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1 data-aos="fade-up">Selamat Datang di <span>Produk Jamur Nagari Limau Manis</span></h1>
                    <p data-aos="fade-up" data-aos-delay="100">Kunjungi katalog kami dan temukan jamur yang cocok untuk
                        kebutuhan kuliner Anda.<br></p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{ route('login') }}" class="btn-get-started">
                            Katalog Produk
                        </a>
                    </div>
                    {{-- <img src="images/jamur.png" class="img-fluid hero-img" alt="" data-aos="zoom-out"
                        data-aos-delay="300"> --}}
                </div>
            </div>
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="images/foto.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-lg-12">
    ...
    <footer id="footer" class="footer position-relative light-background">
        ...
        <div class="container copyright text-center mt-4">
            <p>© 2024 <span>Copyright</span> <strong class="px-1 sitename">
                    Jamur Nagari Limau Manis
